...
echo "        </button>\n        <button id=\"btnAddComment\" type=\"button\" class=\"btn btn-primary btn-sm\">\n            <i class=\"fa fa-comment\" aria-hidden=\"true\"></i>\n            ";
...
foreach( $output["messages"] as $message ) 
{
    ...
    echo "\n            <div class=\"message\" id=\"message-" . $message["id"] . "\">\n                <div class=\"user-gravatar\">\n                    <img src=\"" . $message["gravatarUrl"] . "\">\n                </div>\n                <div class=\"number\">\n                " . $message["number"] . ".\n                </div>\n                <div class=\"content\">\n                    <span class=\"user\">" . $message["name"] . "</span>\n                    <span class=\"date\">" . $message["date"] . "</span>\n                    <div class=\"pull-right\"><input type=\"button\" value=\"" . $language["delete"] . "\" class=\"btn btn-danger btn-xs\" onclick=\"ProjectManager.confirm('deletemsg', 'msgid=" . $message["id"] . "')\"></div>\n                    <span class=\"msg\">" . $message["message"] . "</span>\n                    " . $attachments . "\n                </div>\n            </div>\n        ";
    $i++;
}
...
foreach( $output["timers"] as $timer ) 
{
    ...
    echo $timer["endTime"];
    echo "</td>\n                    <td>";
    echo ($timer["billed"] ? "<i class=\"fa fa-check-circle\"></i>" : "<i class=\"fa fa-times-circle\"></i>");
    echo "</td>\n                    <td";
    echo ($timer["endTime"] != "-" ? "" : " class=\"timer-duration\"");
    echo ">";
    echo $timer["duration"];
    echo "</td>\n                    <td>\n                        <a href=\"#\" class=\"timer-edit\" onclick=\"return false;\"><i class=\"fa fa-pencil\"></i></a>\n                    </td>\n                    <td>\n                        ";
    echo ($timer["billed"] ? "" : "<a href=\"#\" class=\"timer-delete\" onclick=\"return false;\" data-timer-id=\"" . $timer["id"] . "\"><i class=\"fa fa-times text-danger\"></i></a>");
    echo "                    </td>\n                </tr>\n            ";
}
...
echo "            </button>\n        </div>\n        <h2><strong id=\"associatedTicketCount\">";
echo count($output["tickets"]);
echo "</strong> ";
...
foreach( $output["files"] as $key => $file ) 
{
    ...
    echo "\">\n                    <div class=\"pull-right\">\n                        <a id=\"fileView";
    echo $key;
    echo "\" class=\"btn btn-default\" href=\"addonmodules.php?module=project_management&amp;action=dl&amp;projectid=";
    echo $projectId;
    echo "&amp;i=";
    echo $key;
    echo ($file["browserViewable"] ? "&amp;view=inline\" target=\"_blank\"" : "\"");
    if( $file["isImage"] ) 
    {
        echo " data-lightbox=\"project-image-" . $projectId . "\"";
    }
    ...
    echo "                        </a>\n                        <a id=\"fileDownload";
    echo $key;
    echo "\" href=\"addonmodules.php?module=project_management&amp;action=dl&amp;projectid=";
    echo $projectId;
    echo "&amp;i=";
    echo $key;
...
echo "                            </select>\n                        </div>\n                        <div class=\"col-sm-6\">\n                            <strong>";
echo $language["duedate"];
echo "</strong><br />\n                            <input type=\"text\" name=\"duedate\" class=\"form-control date-picker\" placeholder=\"";
echo getTodaysDate();
echo "\" id=\"inputTaskDue\" />\n                        </div>\n                    </div>\n                </div>\n                <div class=\"alert alert-danger error-feedback text-center hidden\"></div>\n                <div class=\"modal-footer\">\n                    <div class=\"pull-left\">\n                        <button type=\"button\" class=\"task-delete-button btn btn-danger\">";
echo $language["delete"];
echo "</button>\n                    </div>\n                    <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">";
...
echo "</strong><br />\n                            <input type=\"text\" class=\"form-control date-picker\" name=\"created\" placeholder=\"";
echo getTodaysDate();
echo "\" id=\"createInvoiceCreated\" />\n                        </div>\n                        <div class=\"col-sm-6\">\n                            <strong>";
echo $language["duedate"];
echo "</strong><br />\n                            <input type=\"text\" class=\"form-control date-picker\" name=\"due\" placeholder=\"";
echo getTodaysDate();
echo "\" id=\"createInvoiceDue\" />\n                        </div>\n                    </div>\n                    <div class=\"row padding-top-10\">\n                        <div class=\"col-sm-6\">\n                            <label for=\"createInvoiceApplyTax\"><strong>";
...
echo $language["starttime"];
echo "</strong><br />\n                            <input id=\"editTimerStartDate\" name=\"start\" type=\"text\" class=\"form-control input-inline input-200 date start\" data-date-format=\"dd/mm/yy\" placeholder=\"";
echo getTodaysDate();
echo "\" />\n                            <input id=\"editTimerStartTime\" name=\"startTime\" type=\"text\" class=\"form-control input-inline input-75 time start\" placeholder=\"9:00am\" />\n                        </div>\n                        <div class=\"col-sm-6\">\n                            <strong>";
echo $language["endTime"];
echo "</strong><br />\n                            <input id=\"editTimerEndDate\" name=\"end\" type=\"text\" class=\"form-control input-inline input-200 date end\" placeholder=\"";
echo getTodaysDate();
echo "\" />\n                            <input id=\"editTimerEndTime\" name=\"endTime\" type=\"text\" class=\"form-control input-inline input-75 time end\" placeholder=\"9:00am\" />\n                        </div>\n                    </div>\n                </div>\n                <div class=\"alert alert-danger error-feedback text-center hidden\"></div>\n                <div class=\"modal-footer\">\n                    <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">";
echo $language["cancel"];
...
echo "                                </select>\n                            </div>\n                        </div>\n                        <div class=\"row padding-top-10\">\n                            <div class=\"col-md-3\">";
echo $language["client"];
echo ":</div>\n                            <div class=\"col-md-9\">\n                                <select name=\"client\" class=\"selectize selectize-client-search\" data-value-field=\"id\" data-allow-empty-option=\"1\" placeholder=\"";
...
echo ";\n    function getClientSearchPostUrl() {\n        return 'addonmodules.php?module=project_management&action=clientSearch&ajax=1&projectid=";
echo $project->id . generate_token("link");
echo "';\n    }\n</script>\n";

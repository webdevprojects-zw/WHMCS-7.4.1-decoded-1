...
{else}
    ...
    <div class="well">
        ...
        <p>For further instructions, please refer to the <a href="https://knowledge.rapidssl.com/support/ssl-certificate-support/index?page=content&id=so16226" target="_blank">RapidSSL Installation Support</a> page.</p>
    </div>

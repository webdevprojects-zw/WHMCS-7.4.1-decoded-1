...
if( $xmlresponse["SUCCESS"] == "1" ) 
{
    ...
    logTransaction($GATEWAY["paymentmethod"], array_merge($_REQUEST, $xmlresponse), "Successful");
    redirSystemURL("id=" . $invoiceid . "&paymentsuccess=true", "viewinvoice.php");
}
else
{
    logTransaction($GATEWAY["paymentmethod"], array_merge($_REQUEST, $xmlresponse), "Unsuccessful");
    if( $invoiceid ) 
    {

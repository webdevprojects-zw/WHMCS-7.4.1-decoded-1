...
if( $intellisearch ) 
{
    ...
    $responses = run_hook("IntelligentSearch", array( "searchTerm" => $value ));
    ...
    else
    {
        ...
        else
        {
            if( $type == "services" ) 
            {
                ...
                redir((string) $searchin . "=" . $q, "clientshostinglist.php");
            }
            else
            {
                if( $type == "domains" ) 
                {
                    ...
                    redir((string) $searchin . "=" . $q, "clientsdomainlist.php");
                }
                else
                {
                    if( $type == "invoices" ) 

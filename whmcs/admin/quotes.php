    ...
    else
    {
        ...
        else
        {
            if( $action == "manage" ) 
            {
                ...
                if( $duplicated ) 
                {
                    infoBox($aInt->lang("quotes", "quoteduplicated"), $aInt->lang("quotes", "quoteduplicatedmsg") . $id, "success");
                }

                if( $sent ) 
                {
                    infoBox($aInt->lang("quotes", "quotedelivered"), $aInt->lang("quotes", "quotedeliveredmsg"), "success");
                }
                ...
                echo $datecreated;
                echo "\" class=\"form-control date-picker\"></td><td class=\"fieldlabel\">";
                ...
                echo "</table>\n\n<div class=\"btn-container\">\n    <input id=\"inputSaveChanges\" type=\"submit\" value=\"Save Changes\" class=\"btn btn-primary\" />\n    <input type=\"button\" value=\"Duplicate\" class=\"button btn btn-default\" onclick=\"window.location='quotes.php?action=duplicate&id=";
                ...
                echo " />\n    <input type=\"button\" value=\"Printable Version\" class=\"button btn btn-default\" onclick=\"window.open('../viewquote.php?id=";
                echo $id;
                ...
                echo " />\n    <input type=\"button\" value=\"View PDF\" class=\"button btn btn-default\" onclick=\"window.open('../dl.php?type=q&id=";
                echo $id;
                echo "&viewpdf=1','pdfquote','')\" />\n    <input type=\"button\" value=\"Download PDF\" class=\"button btn btn-default\" onclick=\"window.location='";
                echo $_SERVER["PHP_SELF"];
                ...
                echo " />\n    <input type=\"button\" id=\"emailAsPdf\" value=\"Email as PDF\" class=\"button btn btn-default\" onclick=\"window.location='quotes.php?action=sendpdf&id=";
                echo $id . generate_token("link");
                echo "';\"";
                if( !$id ) 
                {
                ...
                echo " />\n    <input type=\"button\" id=\"convertToInvoice\" value=\"Convert to Invoice\" class=\"btn btn-default\" data-toggle=\"modal\" data-target=\"#modalQuoteConvert\"";
                if( !$id ) 
                {
                    echo " disabled=\"true\"";
                }

                echo " />\n    <input type=\"button\" value=\"Delete\" class=\"btn btn-danger\" onclick=\"doDelete('";
                echo $id;
                echo "');\"";
                if( !$id ) 
                {
                ...
                echo " />\n    <input type=\"button\" value=\"Email as PDF\" class=\"button btn btn-default\" onclick=\"window.location='quotes.php?action=sendpdf&id=";
                echo $id . generate_token("link");
                echo "';\"";
                if( !$id ) 
                {
                ...
                echo " />\n    <input type=\"button\" value=\"Convert to Invoice\" class=\"btn btn-default\" data-toggle=\"modal\" data-target=\"#modalQuoteConvert\"";
                if( !$id ) 
                {
                    echo " disabled=\"true\"";
                }

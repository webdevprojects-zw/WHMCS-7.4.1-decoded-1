...
if( empty($questions) ) 
{
    echo "  <i class=\"fa fa-info-circle\" aria-hidden=\"true\" data-toggle=\"tooltip\" data-placement=\"right\" title=\"" . $aInt->lang("setup", "activatesecurityqs") . "\"></i>";
}
...
echo "</td><td class=\"fieldarea\"><label class=\"checkbox-inline\"><input type=\"checkbox\" name=\"emailoptout\" tabindex=\"20\"";

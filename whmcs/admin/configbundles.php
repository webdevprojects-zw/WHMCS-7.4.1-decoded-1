        ...
        else
        {
            ...
            else
            {
                if( $action == "manage" ) 
                {
                    ...
                    echo $validuntil;
                    echo "\" /> <label class=\"checkbox-inline\"><input type=\"checkbox\" name=\"noexpiry\"";
                    ...
                    if( $id ) 
                    {
                        echo "<tr><td class=\"fieldlabel\">" . $aInt->lang("bundles", "orderlink") . "</td><td class=\"fieldarea\"><input type=\"text\" name=\"orderlink\" size=\"100\" value=\"" . App::getSystemUrl() . "cart.php?a=add&bid=" . $id . "\" /></td></tr>";
                    }

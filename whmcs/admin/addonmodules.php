...
{
    $aInt->title = "WHMCS Marketplace";
    echo "<div style=\"margin: 0 -15px; padding: 60px 0; text-align: center;\">\n        <a href=\"https://marketplace.whmcs.com/\" target=\"_blank\">\n            <img src=\"//cdn.whmcs.com/assets/img/marketplace-addons-banner.png\" style=\"max-width: 100%; width: auto;\">\n        </a>\n    </div>";
}
else
{

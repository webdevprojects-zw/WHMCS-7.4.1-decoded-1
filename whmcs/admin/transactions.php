...
if( !$action ) 
{
    ...
    echo "</td><td class=\"fieldarea\"><select name=\"show\" class=\"form-control select-inline\">\n<option value=\"\">";
    ...
    echo "</td><td class=\"fieldarea\"><select name=\"within\" class=\"form-control select-inline\"><option value=\"\">";
    ...
    echo "</td><td class=\"fieldarea\"><input type=\"text\" name=\"filterdescription\" class=\"form-control input-300\" value=\"";
    ...
    echo "</td><td class=\"fieldarea\"><input type=\"text\" name=\"filtertransid\" class=\"form-control input-300\" value=\"";
    echo $filtertransid;
    echo "\"></td><td class=\"fieldlabel\">";
...
else
{
    if( $action == "edit" ) 
    {
        ...
        echo $aInt->lang("fields", "date");
        echo "</td>\n        <td class=\"fieldarea\"><input type=\"text\" size=\"12\" name=\"date\" value=\"";
        echo $date;
